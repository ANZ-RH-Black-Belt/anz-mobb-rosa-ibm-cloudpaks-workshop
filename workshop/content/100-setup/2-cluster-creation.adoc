...
[source,sh,role=execute]
----
wait -n 90 rosa describe cluster --cluster rosa-${GUID}
----


. Once you see the following output from the API your cluster has finished the installation and is ready to use:
