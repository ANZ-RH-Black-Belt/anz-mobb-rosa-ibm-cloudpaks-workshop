...
AWS CONSOLE USERNAME>> %aws_web_console_user_name%
AWS CONSOLE PASSWORD>> %aws_web_console_password%
ROSA CONSOLE USERNAME>> %rosa_console_user_name%
ROSA CONSOLE PASSWORD>> %rosa_console_password%
ROSA BASTION USER NAME>> %rosa_bastion_user_name%
ROSA USER PASSWORD>> %rosa_user_password%
ROSA SUBDOMAIN BASE>> %rosa_subdomain_base%
ROSA SANDBOX ACCOUNT ID>> %rosa_sandbox_account_id%
